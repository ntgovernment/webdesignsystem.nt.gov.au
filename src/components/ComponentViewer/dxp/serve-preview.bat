...
if exist "deploy\web-design-system.css" (
  copy deploy\web-design-system.css "%STORYBOOK_PUBLIC%\" >nul
  echo âœ“ Copied web-design-system.css
)

echo.
echo âœ… Preview files copied to storybook-static\
echo.
echo ðŸš€ Start with one of these methods:
