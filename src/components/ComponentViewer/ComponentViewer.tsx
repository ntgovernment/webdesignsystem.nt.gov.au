      ...
      case 'two-column':
        return (
          <div className="demo-container">
            ...
            <p>A responsive two-column layout component that automatically stacks on mobile.</p>
            <TwoColumn
              leftContent={
                <div className="demo-content">
                  <h3>Left Column</h3>
                  <p>This is the left column content. It can contain any React components or HTML.</p>
                </div>
              }
              rightContent={
                <div className="demo-content">
                  <h3>Right Column</h3>
                  <p>This is the right column content. The columns will stack on mobile devices.</p>
                </div>
              }
            />
      ...
      case 'theme-switcher':
        return (
          <div className="demo-container">
            ...
            <p>A component that allows users to switch between light and dark themes.</p>
            <div className="demo-content">
              <ThemeSwitcher />
            </div>
            <div className="theme-demo">
              ...
              <div className="theme-card" style={{
                ...
                <p>This card uses theme variables and will change with the selected theme.</p>
                <ul>
  ...
  return (
    <div className="nt-component-viewer">
      <header className="viewer-header">
        <h1>NT Design System - Component Viewer</h1>
        <ThemeSwitcher />
      </header>
