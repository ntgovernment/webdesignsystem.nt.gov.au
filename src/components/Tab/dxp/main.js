...
const main = async (input) => {
  ...
  return `<div class="sq-inline-viper-content nt-tab-marker" data-tab-title="${escapeAttr(title)}" data-tab-id="${escapeAttr(tabId)}" style="min-height: 18.5px; border: 1px solid transparent;"><hr><p data-sq-field="title">${escapeHtml(title)}</p><hr><p></p><p></p></div>`;
};
